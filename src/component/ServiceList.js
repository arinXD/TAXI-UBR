    ...
    return(
        <div className="service-list me-3">
            <div className="hero-wrap">
                <h1>บริการแท็กซี่</h1>
                <p className="describe">พูดคุยตกลงราคาได้ค่ะ ขอบคุณที่ใช้บริการ <i className="bi bi-emoji-smile-fill"></i> </p>
                {/* <img style={{
                    width:'100%',
                    display:'block',
                    height: '400px',
            ...
            <div className="service-wrap">
                <ul className="detail-list">
                    ...
                    <li><i className="bi bi-check-lg"></i> <span>ตัวเมืองขอนแก่น</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>บขส 3 ขอนแก่น</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>สนามบินขอนแก่น</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>ส่วนตัว</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>รับส่งต่างจังหวัด ต่างอำเภอ ทุกทิศทั่วไทย</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>เหมาแท็กซี่ไปต่างจังหวัด ต่างอำเภอ</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>เหมารถ เหมารถตู้ เช่ารถตู้ พร้อมคนขับ</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>แท็กซี่ขนาดใหญ่ 7 ที่นั่ง</span></li>
                </ul>
                <ul className="detail-list">
                ...
                <ul className="detail-list">
                    <h2>เหมาแท็กซี่</h2>
                    <ul className="grid-2">
                    <li><i className="bi bi-check-lg"></i> <span>สนามบินสุวรรณภูมิ</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>สนามบินภูเกต</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>สนามบินดอนเมือง</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>สนามบินอุดรธานี</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>สนามบินขอนแก่น</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>สนามบินร้อยเอ็ด</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>พัทยา</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>ตราด</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>ขอนแก่น</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>กรุงเทพฯ</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>ระยอง</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>ชลบุรี</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>มหาสารคาม</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>อุดรธานี</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>ร้อยเอ็ด</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>โคราช</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>จันทบุรี</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>ลพบุรี</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>อรัญประเทศ</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>สระแก้ว</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>ภูเก็ต</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>มุกดาหาร</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>หนองคาย</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>กาฬสินธุ์</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>บึงกาฬ</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>นครพนม</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>พิษณุโลก</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>เชียงใหม่</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>สุโขทัย</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>เพชรบูรณ์</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>ตราด</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>เมืองเลย</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>ชัยภูมิ</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>อุบลราชธานี</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>หนองบัวลำภู</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>ชัยภูมิ</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>สุรินทร์</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>สุพรรณบุรี</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>ฉะเชิงเทรา</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>เชียงราย</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>สกลนคร</span></li>
                    <li><i className="bi bi-check-lg"></i> <span>อำนาจเจริญ</span></li>
                    </ul>
                </ul>
                <ul className="detail-list">
