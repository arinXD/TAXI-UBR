                        ...
                        <div class="padding-top col-lg-4 ">
                            ...
                            <div class="card mb-3 border-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">หนึ่งในสถานที่ท่องเที่ยวคือที่นี่ “สระมรกต”
                                        เกิดจากการระเบิดหิน ของโรงโม่หินพอระเบิดหินไปเรื่อยๆ จนกลายเป็นแอ่งน้ำขนาดใหญ่ และกลายเป็นแหล่งท่องเที่ยว
                                        ครั้งนี้มาตั้งแต่เช้า มาถึงประมาณ 07.00น. เพื่อจะได้เห็นภาพภูเขาสะท้อนอยู่ในวิวน้ำ พระอาทิตย์กำลังขึ้น ดูสวยงามดีครับ 🔋🍃</p>
                                                ...
                                                <div class="accordion-body">
                                                    <div class="card bg-dark text-white border-img">
                                                        ...
                                                        <div class="card-img-overlay">
                                                            ...
                                                            <p class="card-text">สถานที่ท่องเที่ยวน่าจะเพิ่งได้ไม่นานนัก
                                                                ตอนเดินทางไปจากอำเภอภูผาม่าน
                                                                จอดรถขนานไปกับแนวถนน ถ้าเป็นวันหยุดมีนักท่องเที่ยวมากน่าจะติดขัดบ้าง
                                                                สถานที่สวยงาม ตอนกลางวันแดดแรงแต่มีต้นไม้ให้ร่มเงาดี</p>
                                                            <div class='d-flex justify-content-between '>
